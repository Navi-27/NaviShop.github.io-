                ...
                <div class="row ">
                        ...
                        <div class="card m-0">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center justify-content-center aligns-items-center card-img p-3">
                                    <img src="<?php echo media();?>/images/uploads/silla1.png" class="card-img-top " alt="silla rimax">
                                </div>
                                    <div class="buton">
                    ...
                    <div class="col-md-4">
                        <div class="card m-0">
                            ...
                            <hr>
                                <div class="d-flex justify-content-center justify-content-center aligns-items-center card-img p-3">
                                    <img src="<?php echo media();?>/images/uploads/mesa.png" class="card-img-top " alt="silla rimax">
                                </div>
                                <div class="buton">
                                <a href="<?php echo base_url(); ?>Productos/View/1/">
                                            <button class="card-text btn text-body-secondary" >ITEM:"$item"_______REFERENCIA:"$referencia"</button>
                    ...
                    <div class="col-md-4">
                        <div class="card m-0">
                            <div class="card-body">
                                ...
                                <hr>
                                <div class="d-flex justify-content-center justify-content-center aligns-items-center card-img p-3">
                                    <img src="<?php echo media();?>/images/uploads/termo11.png" class="card-img-top " alt="silla rimax">
                                </div>
                                <div class="buton">
                                <a href="<?php echo base_url(); ?>Productos/View/1/">
                                            <button class="card-text btn text-body-secondary" >ITEM:"$item"_______REFERENCIA:"$referencia"</button>
                    ...
                    <div id="contenedor-cards" class="row">
                        <!-- Las tarjetas se agregarán aquí automáticamente -->
                    </div>
                </div>
            </div>
        </div>
